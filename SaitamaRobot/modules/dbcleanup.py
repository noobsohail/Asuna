...
import ShigeoRobot.modules.sql.global_bans_sql as gban_sql
import ShigeoRobot.modules.sql.users_sql as user_sql
from ShigeoRobot import DEV_USERS, OWNER_ID, dispatcher
